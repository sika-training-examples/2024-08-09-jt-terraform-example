resource "azurerm_storage_account" "this" {
  ...
  blob_properties {
    versioning_enabled  = var.blob_storage.versioning_enabledversioning_enabled
    change_feed_enabled = var.blob_storage.versioning_enabled.change_feed_enabled

    delete_retention_policy {
      days = var.blob_storage.delete_retention_policy_days
    }
    restore_policy {
      days = var.blob_storage.restore_policy_days
    }
    container_delete_retention_policy {
      days = var.blob_storage.container_delete_retention_policy_days
    }
  }
